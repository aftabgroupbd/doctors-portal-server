...
async function run() {
    ...
    try {
        ...
        const appointmentsCollection = database.collection('appointmens');
        ...
        app.get('/appointments', async (req, res) => {
            ...
            const appointmens = await cursor.toArray();
            res.json(appointmens);
        })
        ...
        app.put('/users/admin', verifyToken, async (req, res) => {
            ...
            if (requster) {
                const requesterAccount = await usersCollection.findOne({ email: requster });
